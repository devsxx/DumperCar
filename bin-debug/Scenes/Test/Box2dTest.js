...
var Box2dTest = (function (_super) {
    __extends(Box2dTest, _super);
    function Box2dTest() {
        var _this = _super.call(this) || this;
        _this.p2m = 30;
        return _this;
    }
    Box2dTest.prototype.childrenCreated = function () {
    ...
    Box2dTest.prototype.createBox = function (posX, posY, w, h, isStatic) {
    ...
    Box2dTest.prototype.createWorld = function () {
        var gravity = new Box2D.Common.Math.b2Vec2(0, 10);
        this.world = new Box2D.Dynamics.b2World(gravity, true);
    };
    Box2dTest.prototype.createDebug = function () {
    ...
    Box2dTest.prototype.loop = function (e) {
        this.world.Step(1 / 60, 10, 10);
        this.world.DrawDebugData();
    };
    return Box2dTest;
}(eui.Component));
__reflect(Box2dTest.prototype, "Box2dTest");
//# sourceMappingURL=Box2dTest.js.map