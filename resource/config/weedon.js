var egret = window.egret;var module = module || {};
var sdk, conf;
...
(function (module, exports) {
      ...
      value: function (callback) {
        if(typeof GameGlobal === "undefined"){
          ...
          wx.onShow(function (res) {
            callback(res.query, res.shareTicket);
          });
        }
      }
    },
  ...
  if (typeof GameGlobal !== "undefined") {
    ...
    Object.defineProperties(exports, {
      ...
      initChannelConfig: {
        value: function (shareParams,shareCallback,payCallback) {
          wx.showShareMenu({
          ...
          shareParams.wxGame = shareParams.wxGame || {};
          shareParams.wxGame.success = function(res){
            shareCallback(0,res)
          }
          shareParams.wxGame.fail = function(){
            shareCallback(1);
          }
          sdk.onShareAppMessage(shareParams.wxGame);
      ...
      getShareInfo:{
        value:function(userId,shareTicket,callback){
          sdk.getShareInfo({
