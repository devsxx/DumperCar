...
generateEUI.paths['resource/eui_skins/DuelSceneSkin.exml'] = window.DuelSceneSkin = (function (_super) {
	...
	function RankingItemSkin() {
		_super.call(this);
		this.skinParts = ["avatar","nickname","totalShootLabel","totalHitLabel","headHitLabel"];
		
		this.height = 100;
		this.width = 520;
		this.elementsContent = [this._Rect1_i(),this.avatar_i(),this.nickname_i(),this._Label1_i(),this.totalShootLabel_i(),this.totalHitLabel_i(),this.headHitLabel_i()];
	}
	...
	function RankingListSkin() {
		_super.call(this);
		this.skinParts = ["btnStart","totalShootLabel","totalHitLabel","headHitLabel"];
		
		this.height = 900;
		this.width = 560;
		this.elementsContent = [this._Rect1_i(),this._Label1_i(),this._Label2_i(),this._Label3_i(),this._Group1_i(),this.btnStart_i(),this.totalShootLabel_i(),this.totalHitLabel_i(),this.headHitLabel_i()];
	}
