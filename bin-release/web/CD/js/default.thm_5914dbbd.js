...
generateEUI.paths['resource/eui_skins/DuelSceneSkin.exml'] = window.DuelSceneSkin = (function (_super) {
	...
	_proto.topUI_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.bulletList_i(),this.reloadTag_i()];
		return t;
	};
	...
	_proto.btnBack_i = function () {
		...
		this.btnBack = t;
		t.anchorOffsetX = 97.93;
		t.anchorOffsetY = 33.41;
		t.height = 70;
	...
	function DuanWeiComponentSkin() {
		_super.call(this);
		this.skinParts = ["bgImg","star_bg","star_bg6","star3_1","star3_2","star3_3","star4_1","star4_2","star4_3","star4_4","star5_1","star5_2","star5_3","star5_4","star5_5","star6TF","star6Img","numBF"];
		
		this.height = 187.5;
		this.width = 212;
		this.elementsContent = [this.bgImg_i(),this.star_bg_i(),this.star_bg6_i(),this.star3_1_i(),this.star3_2_i(),this.star3_3_i(),this.star4_1_i(),this.star4_2_i(),this.star4_3_i(),this.star4_4_i(),this.star5_1_i(),this.star5_2_i(),this.star5_3_i(),this.star5_4_i(),this.star5_5_i(),this.star6TF_i(),this.star6Img_i(),this.numBF_i()];
	}
	...
	function MailDialogSkin() {
		_super.call(this);
		this.skinParts = ["bg","backBtn","numTF","list"];
		
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this._Rect1_i(),this.bg_i(),this.backBtn_i(),this._Label1_i(),this.numTF_i(),this._Scroller1_i(),this._Image1_i(),this._Image2_i()];
	}
	...
	function MainSceneSkin() {
		_super.call(this);
		this.skinParts = ["bg","carImg","grassImg","grassImg0","bgImg","tabBtn1","tabBtn2","tabBtn3","personGrp","propBtn","propList","propScroll","weaponBtn","weaponList","weaponScroll","middleGrp","headImg","clickImg","nameTF","lvTF","coinTF","chargeBtn","diamondTF","prgMc","prgTF","prgCd","buyTiBtn","dwMc","topUI","leftBtn","rightBtn","bottomUI","mainBtn1","mainBtn2","mainBtn3","mainBtn4","mainBtn5","pageGroup","duelGrp","dialogGrp"];
		
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this.bg_i(),this.carImg_i(),this.grassImg_i(),this.grassImg0_i(),this.bgImg_i(),this.tabBtn1_i(),this.tabBtn2_i(),this.tabBtn3_i(),this.middleGrp_i(),this.topUI_i(),this.bottomUI_i(),this.mainBtn1_i(),this.mainBtn2_i(),this.mainBtn3_i(),this.mainBtn4_i(),this.mainBtn5_i(),this.pageGroup_i(),this.duelGrp_i(),this.dialogGrp_i()];
	}
	...
	_proto.topUI_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this.headImg_i(),this.clickImg_i(),this.nameTF_i(),this.lvTF_i(),this._Image2_i(),this.coinTF_i(),this._Image3_i(),this.chargeBtn_i(),this.diamondTF_i(),this._Image4_i(),this.prgMc_i(),this.prgTF_i(),this._Image5_i(),this._Label1_i(),this.prgCd_i(),this.buyTiBtn_i(),this.dwMc_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	function SettingDialogSkin() {
		_super.call(this);
		this.skinParts = ["bg","headImg","versionTF","shareBtn1","shareBtn2","lvTF","nameTF","dwImg","dwMc","pwTF","starTF","yyMc","yxMc","ATF","BTF","CTF","DTF","ETF","FTF","mzImg","lvPrg","expTF"];
		
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this.bg_i(),this._Image1_i(),this.headImg_i(),this._Image2_i(),this.versionTF_i(),this.shareBtn1_i(),this.shareBtn2_i(),this.lvTF_i(),this.nameTF_i(),this.dwImg_i(),this.dwMc_i(),this._Image3_i(),this._Image4_i(),this.pwTF_i(),this._Label1_i(),this.starTF_i(),this._Image5_i(),this.yyMc_i(),this.yxMc_i(),this._Rect1_i(),this.ATF_i(),this.BTF_i(),this.CTF_i(),this.DTF_i(),this.ETF_i(),this.FTF_i(),this._Image6_i(),this.mzImg_i(),this.lvPrg_i(),this.expTF_i()];
	}
	...
	_proto.shareBtn1_i = function () {
		var t = new eui.Component();
		this.shareBtn1 = t;
		t.anchorOffsetX = 65.49;
		t.anchorOffsetY = 24.73;
		t.height = 50;
		t.skinName = "CommonBtn2Skin";
		t.width = 130;
		t.x = 492.49;
	...
	_proto.shareBtn2_i = function () {
		var t = new eui.Component();
		this.shareBtn2 = t;
		t.anchorOffsetX = 65.58;
		t.anchorOffsetY = 23.18;
		t.height = 50;
		t.skinName = "CommonBtn2Skin";
		t.width = 130;
		t.x = 488.58;
	...
	function MailItemRenderSkin() {
		_super.call(this);
		this.skinParts = ["nameTF","timeTF"];
		
		this.height = 112;
		this.width = 590;
		this.elementsContent = [this._Image1_i(),this.nameTF_i(),this.timeTF_i()];
	}
	...
	function RankItemRenderSkin() {
		_super.call(this);
		this.skinParts = ["bgImg","nameTF","lvTF","dwTF","starTF","jbImg","headImg","dwImg","mzImg","rankTF","dwMc"];
		
		this.height = 112;
		this.width = 590;
		this.elementsContent = [this.bgImg_i(),this.nameTF_i(),this.lvTF_i(),this.dwTF_i(),this.starTF_i(),this._Image1_i(),this.jbImg_i(),this.headImg_i(),this._Image2_i(),this.dwImg_i(),this.mzImg_i(),this.rankTF_i(),this.dwMc_i()];
	}
