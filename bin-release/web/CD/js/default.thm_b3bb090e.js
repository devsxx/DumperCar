...
generateEUI.paths['resource/eui_skins/DuelSceneSkin.exml'] = window.DuelSceneSkin = (function (_super) {
	...
	function GroupRankDialogSkin() {
		_super.call(this);
		this.skinParts = ["bg","middleBg","list","scroll","groupName","middleGroup","bottomGroup","backBtn"];
	...
	_proto.bottomGroup_i = function () {
		...
		t.x = 320;
		t.y = 1155.5;
		t.elementsContent = [this._Image5_i(),this._Image6_i(),this._Image7_i(),this._Label1_i(),this._Label2_i(),this._Image8_i(),this._Label3_i()];
		return t;
	};
	_proto._Image5_i = function () {
		var t = new eui.Image();
	...
	function PropCompareSkin() {
		_super.call(this);
		this.skinParts = ["bg","middleBg","ATF","BTF","CTF","DTF","ETF","FTF","mePropGroup","leftMc","rightMc","compareGroup","middleGroup","bottomGroup","backBtn"];
	...
	_proto.bottomGroup_i = function () {
		...
		t.x = 320;
		t.y = 1155.5;
		t.elementsContent = [this._Image3_i(),this._Image4_i(),this._Image5_i(),this._Label2_i(),this._Label3_i(),this._Image6_i(),this._Label4_i()];
		return t;
	};
	_proto._Image3_i = function () {
		var t = new eui.Image();
	...
	function RankInstructionSkin() {
		_super.call(this);
		this.skinParts = ["rect","title","info0","rankIns0","rankIcon0_0","rankIcon0_1","rankIns1","rankIcon1_0","rankIcon1_1","rankIns2","rankIcon2_0","rankIcon2_1","rankIns3","rankIcon3_0","insGroup"];
	...
	_proto.insGroup_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 476;
		t.elementsContent = [this.title_i(),this.info0_i(),this.rankIns0_i(),this.rankIcon0_0_i(),this.rankIcon0_1_i(),this.rankIns1_i(),this.rankIcon1_0_i(),this.rankIcon1_1_i(),this.rankIns2_i(),this.rankIcon2_0_i(),this.rankIcon2_1_i(),this.rankIns3_i(),this.rankIcon3_0_i()];
		return t;
	};
	_proto.title_i = function () {
		var t = new eui.Label();
