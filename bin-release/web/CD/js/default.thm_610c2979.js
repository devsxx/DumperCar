...
generateEUI.paths['resource/eui_skins/DuelSceneSkin.exml'] = window.DuelSceneSkin = (function (_super) {
	...
	function MainSceneSkin() {
		_super.call(this);
		this.skinParts = ["bg","carImg","grassImg","grassImg0","bgImg","personGrp","propBtn","propList","propScroll","weaponBtn","weaponList","weaponScroll","middleGrp","headImg","clickImg","nameTF","lvTF","coinTF","chargeBtn","diamondTF","prgMc","prgTF","prgCd","buyTiBtn","topUI","leftBtn","rightBtn","bottomUI","mainBtn1","mainBtn2","mainBtn3","mainBtn4","mainBtn5","tabBtn1","tabBtn2","pageGroup","dialogGrp","duelGrp"];
		
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this.bg_i(),this.carImg_i(),this.grassImg_i(),this.grassImg0_i(),this.bgImg_i(),this.middleGrp_i(),this.topUI_i(),this.bottomUI_i(),this.mainBtn1_i(),this.mainBtn2_i(),this.mainBtn3_i(),this.mainBtn4_i(),this.mainBtn5_i(),this.tabBtn1_i(),this.tabBtn2_i(),this.pageGroup_i(),this.dialogGrp_i(),this.duelGrp_i()];
	}
	...
	_proto.topUI_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this.headImg_i(),this.clickImg_i(),this.nameTF_i(),this.lvTF_i(),this._Image2_i(),this._Image3_i(),this.coinTF_i(),this._Image4_i(),this.chargeBtn_i(),this.diamondTF_i(),this._Image5_i(),this.prgMc_i(),this.prgTF_i(),this._Image6_i(),this._Label1_i(),this.prgCd_i(),this.buyTiBtn_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	function SettingDialogSkin() {
		_super.call(this);
		this.skinParts = ["bg","versionTF","shareBtn1","shareBtn2","lvTF","nameTF","pwImg","pwTF","starTF","yyMc","yxMc","ATF","BTF","CTF","DTF","ETF","FTF"];
		
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this.bg_i(),this._Image1_i(),this._Image2_i(),this.versionTF_i(),this.shareBtn1_i(),this.shareBtn2_i(),this.lvTF_i(),this.nameTF_i(),this.pwImg_i(),this._Image3_i(),this._Image4_i(),this.pwTF_i(),this.starTF_i(),this._Image5_i(),this.yyMc_i(),this.yxMc_i(),this._Rect1_i(),this.ATF_i(),this.BTF_i(),this.CTF_i(),this.DTF_i(),this.ETF_i(),this.FTF_i()];
	}
	...
	function RankItemRenderSkin() {
		_super.call(this);
		this.skinParts = ["bgImg","nameTF","lvTF","costImg","dwTF","starTF"];
		
		this.height = 112;
		this.width = 590;
		this.elementsContent = [this.bgImg_i(),this.nameTF_i(),this.lvTF_i(),this.costImg_i(),this.dwTF_i(),this.starTF_i(),this._Image1_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this._Image5_i()];
	}
