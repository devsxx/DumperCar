...
generateEUI.paths['resource/eui_skins/DuelSceneSkin.exml'] = window.DuelSceneSkin = (function (_super) {
	...
	function MainSceneSkin() {
		...
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this.bg_i(),this.carImg_i(),this.grassImg_i(),this.grassImg0_i(),this.tabBtn1_i(),this.tabBtn2_i(),this.tabBtn3_i(),this.middleGrp_i(),this.topUI_i(),this.bottomUI_i(),this.mainBtn1_i(),this.mainBtn2_i(),this.mainBtn3_i(),this.mainBtn4_i(),this.mainBtn5_i(),this.pageGroup_i(),this.guide_i(),this.duelGrp_i(),this.dialogGrp_i(),this.itemsShowGrp_i()];
	}
	...
	_proto.topUI_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this.headImg_i(),this._Image2_i(),this._Image3_i(),this.clickImg_i(),this.nameTF_i(),this.img_coin_i(),this.coinTF_i(),this.img_diamond_i(),this.chargeBtn_i(),this.diamondTF_i(),this.prgMc_i(),this.prgTF_i(),this.tiImg_i(),this.prgCd_i(),this.buyTiBtn_i(),this.dwMc_i(),this.expPrg_i(),this.lvTF_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.guideDialog_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image4_i(),this.guideText_i()];
		return t;
	};
	_proto._Image4_i = function () {
		var t = new eui.Image();
	...
	function FBInvalidSkin() {
		_super.call(this);
		this.skinParts = ["bg","reasonTag","btn0","btn1"];
		
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this.bg_i(),this._Image1_i(),this.reasonTag_i(),this._Label1_i(),this.btn0_i(),this.btn1_i()];
	}
	...
	function MatchingSceneSkin() {
		_super.call(this);
		this.skinParts = ["bg","backBtn","vs","leftBtn","middleBtn","bottomBtn","rightBtn","leftMc","rightMc","counterDown"];
		
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this._Rect1_i(),this.bg_i(),this.backBtn_i(),this.vs_i(),this.leftBtn_i(),this.middleBtn_i(),this.bottomBtn_i(),this.rightBtn_i(),this.leftMc_i(),this.rightMc_i(),this.counterDown_i()];
	}
	...
	function GroupRankDialogSkin() {
		_super.call(this);
		this.skinParts = ["bg","tabBtn1","tabBtn2","topGroup","desTF","middleBg","list","scroll","middleGroup","bottomGroup","backBtn"];
	...
	_proto.bottomGroup_i = function () {
		...
		t.width = 640;
		t.y = 1061;
		t.elementsContent = [this._Image4_i(),this._Image5_i(),this._Image6_i(),this._Label1_i(),this._Label2_i(),this._Image7_i(),this._Label3_i()];
		return t;
	};
	_proto._Image4_i = function () {
		var t = new eui.Image();
	...
	function StrenghForFreeItemSkin() {
		_super.call(this);
		this.skinParts = ["diamondTF","iconImg"];
		
		this.height = 146;
		this.width = 590;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.diamondTF_i(),this.iconImg_i(),this._Label1_i(),this._Image3_i()];
	}
