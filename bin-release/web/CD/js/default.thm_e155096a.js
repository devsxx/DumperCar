...
generateEUI.paths['resource/eui_skins/DuelSceneSkin.exml'] = window.DuelSceneSkin = (function (_super) {
	...
	function BattleEndDialogSkin() {
		_super.call(this);
		this.skinParts = ["bg","effImg","desTF1","desTF2","lvTF","dwMc2","dwImg2","dwMc1","dwImg1","rewardTF","leftBtn","rightBtn"];
		
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this._Rect1_i(),this.bg_i(),this._Image1_i(),this.effImg_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this.desTF1_i(),this.desTF2_i(),this.lvTF_i(),this.dwMc2_i(),this.dwImg2_i(),this.dwMc1_i(),this.dwImg1_i(),this._Image5_i(),this.rewardTF_i(),this._Label1_i(),this._Label2_i(),this._Image6_i(),this.leftBtn_i(),this.rightBtn_i()];
	}
	...
	function MailDialogSkin() {
		...
		this.height = 1386;
		this.width = 640;
		this.elementsContent = [this._Rect1_i(),this.bg_i(),this.backBtn_i(),this._Label1_i(),this.numTF_i(),this._Scroller1_i(),this._Image1_i(),this._Image2_i(),this.topUi_i(),this.noneTF_i()];
	}
	...
	_proto.grp2_i = function () {
		...
		t.x = 138;
		t.y = 618.3;
		t.elementsContent = [this.tweenImg_i(),this._Image2_i(),this._Image3_i(),this.desTF2_i(),this._Label1_i()];
		return t;
	};
